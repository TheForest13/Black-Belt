...
public class ExchangerEx {
    public static void main(String[] args) {
        ...
        List<Action> friend1Acton = new ArrayList<>();
        friend1Acton.add(Action.NOJNICI);
        friend1Acton.add(Action.BUMAGA);
        friend1Acton.add(Action.NOJNICI);
        List<Action> friend2Acton = new ArrayList<>();
        friend2Acton.add(Action.BUMAGA);
        friend2Acton.add(Action.KAMEN);
        friend2Acton.add(Action.KAMEN);
        new BestFriend("Vanya", friend1Acton, exchanger);
        new BestFriend("Petya", friend2Acton, exchanger);
    }
}
